...
(impl-trait 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.nft-approvable-trait.nft-approvable-trait)
...
;; map id to its tier.
(define-constant ID-TO-TIER (list u8 u7 u6 u5 u4 u3 u2 u1 u0 ))
